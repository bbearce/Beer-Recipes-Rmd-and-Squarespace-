...
Ing1 <- data.frame(Grains = "British Pale Ale Malt (3.5 °L)", 
                   Lbs = 6.5, 
                   Potential_SG = 1.036,
                   EZ_Water_Code = 2,
                   SRM = 0.0
                   )
Ing2 <- data.frame(Grains = "British Pale Ale Malt (3.5 °L)", 
                   Lbs = 6.5, 
                   Potential_SG = 1.036,
                   EZ_Water_Code = 2,
                   SRM = 0.0
...
fermentables <- rbind(Ing1,Ing2)
tot_Lbs <- sum(Grains$Lbs)
...
hop1 <- data.frame(Hop = "East Kent Golding", Hop_Type = "pellet", Alpha_Acid_Percent = 0.055, Weight_Oz = 0.75, Boil_Time = 60)
hop2 <- data.frame(Hop = "East Kent Golding", Hop_Type = "pellet", Alpha_Acid_Percent = 0.055, Weight_Oz = 0.75, Boil_Time = 60)
...
time1 <- data.frame(Temp = 62, Days = 7)
time2 <- data.frame(Temp = 70, Days = 7)
time3 <- data.frame(Temp = 60, Days = 7)
time4 <- data.frame(Temp = 60, Days = 7)
